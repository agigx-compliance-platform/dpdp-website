...
const testimonials = [
  {
    quote:
      'AGIGx transformed our compliance posture from a spreadsheet nightmare into a live, auditable system. We went from zero visibility to full control in 8 weeks.',
    author: 'Priya Sharma',
