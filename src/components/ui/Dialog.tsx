...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      'data-[state=open]:animate-fade-in data-[state=closed]:animate-[fadeIn_200ms_ease-out_reverse]',
      className
    )}
    {...props}
  />
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'glass-card p-6',
        'data-[state=open]:animate-slide-up data-[state=closed]:animate-[slideUp_200ms_ease-out_reverse]',
        className
      )}
      {...props}
    >
